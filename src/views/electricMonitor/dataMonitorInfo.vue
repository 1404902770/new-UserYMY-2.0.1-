        ...
        <template v-if="tableData.length>0">
          ...
          >
            ...
            >
              <div style="flex:1">
                <img
                  style="width:60px;margin-top: 60px;margin-left: 36px;"
                  src="../../../public/static/images/xianlu.png"
                  alt=""
                >
              </div>
              ...
              <div style="flex:3">
                ...
                <i :style="item.statu == 1?'color:#1478c5;':'color:#F56C6C;'">{{ item.statu == 1?'在线':'离线' }}</i>
                <!-- <i
...
export default {
  ...
  created() {
    ...
    if (this.$route.query.nid) {
      this.getOptions()
      this.form.region = this.$route.query.nid
      this.getAllShunt()
    } else {
      this.getOptions()
    }
    this.nid = this.$route.query
    // setTimeout(() => {
    //   this.getAllShunt();
    // }, 500)
  }
