<template>
  ...
  <div class="login">
    ...
    <img
      ...
      alt
      style="width:474px;margin-top: 8%;position: absolute;left: 50%;transform: translate(-50%,0);"
    />
    <el-form
      :model="ruleForm"
      :rules="rules"
      ...
      class="demo-ruleForm"
    >
      <h2 style="font-size:26px;color:#fff;letter-spacing:6px">智能用电管理平台</h2>
      <!-- <div>
        <img
      ...
      <el-form-item
        ...
        class="z2"
      >
        <div style="overflow: hidden;width: 68%; border-radius: 6px;border: 1px solid #006cc8;">
          <img
            class="lb"
        ...
        <div style="overflow: hidden;width: 26%; border-radius: 6px;border: 1px solid #006cc8;text-align:center">
          <el-tooltip
            class="item"
            effect="light"
            content="点击更新"
...
.login {
  height: 100%;
  background: url("../../public/static/images/bj@2x-min.png") center no-repeat
    no-repeat;
  ...
  .el-form {
    ...
    // width: 550px;
    width: 450px;
    background: url("../../public/static/images/denglukuang@2x.png") center
      no-repeat no-repeat;
    background-size: 100% 100%;
    overflow: hidden;
    margin: auto;
    ...
    .el-form-item {
      ...
      .z1 {
        width: 89%;
        float: right;
        // box-shadow: inset 0 0 0 1000px #0fc4f6 !important;
      }
    }
    .yzm {
      float: left;
    ...
    .z2:nth-of-type(3) /deep/ .el-form-item__content {
      display: flex;
    }
  }
  .usebrowser {
...
.login /deep/ .el-button--primary {
  ...
  border: none;
  background-image: linear-gradient(to top, #0060ff, #0096ff);
  // border-color: #0782e0;
  // width: 140px;
  margin-top: 40px;
}
